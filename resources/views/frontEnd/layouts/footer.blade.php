            ...
            <div class="row">
                <div class="col-sm-2">
                    <div class="companyinfo">
                        <h2><span>durabak</span>store</h2>
                        <p>Official distributor of Durabak Industries. With the stated goal of providing excellent technical support.</p>
                    </div>
                </div>
                <div class="col-sm-7">
                    <div class="col-sm-3">
                ...
                <div class="col-sm-3">
                    <div class="address">
                        ...
                        <p>900 Haddon Ave #114 Collingswood, NJ 08108</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-sm-3 col-sm-offset-1">
                    <div class="single-widget">
                        ...
                        <form action="#" class="searchform">
                            ...
                            <p>Contact us for a free sample of Durabak! We would love to help you find the right product for your project!</p>
                        </form>
                    </div>
                </div>
