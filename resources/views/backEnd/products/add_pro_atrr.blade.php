                                ...
                                <li>
                                    <form action="{{route('product_attr.store')}}" method="post" role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="material" value="{{old('material')}}" id="material" placeholder="Material" required>
                                            <span style="color: red;">{{$errors->first('price')}}</span>
                    ...
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <form action="{{route('product_attr.update',$product->id)}}" method="post" role="form">
                                ...
                                <tr>
                                    <td class="taskDesc">
                                        <input type="text" name="sku[]" id="sku" class="form-control" value="{{$attribute->sku}}" required="required" style="width: 50px;">
                                    </td>
                                    <td class="taskStatus">
                                        <input type="text" name="size[]" id="size" class="form-control" value="{{$attribute->size}}" required="required" style="width: 50px;">
                                    </td>
                                    <td class="taskOptions">
                                        <input type="text" name="price[]" id="price" class="form-control" value="{{$attribute->price}}" required="required" style="width: 50px;">
                                    </td>
                                    <td class="taskOptions">
                                        <input type="text" name="stock[]" id="stock" class="form-control" value="{{$attribute->stock}}" required="required" style="width: 50px;">
                                    </td>
                                    <td class="taskOptions">
                                        <input type="text" name="color[]" id="color" class="form-control" value="{{$attribute->color}}" required="required" style="width: 50px;">
                                    </td>
                                    <td class="taskOptions">
                                        <input type="text" name="material[]" id="material" class="form-control" value="{{$attribute->material}}" required="required" style="width: 50px;">
                                    </td>
