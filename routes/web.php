...
/// Shipping
//  Route::get('/address','ShippingController@shipping');
Route::get('/list-products','IndexController@shop');
Route::get('/instruction','IndexController@instruction');
...
Route::get('/address','CartController@shipping')->name('shipping');
...
Route::group(['prefix'=>'admin','middleware'=>['auth','admin']],function (){
    ...
    /// Setting Area
    //  Route::get('/', 'NotificationsController@notification');
    Route::get('/page', 'PagesController@index');
    Route::get('/page','PagesController@buying');
    Route::get('/page/completed/{id}','PagesController@completed');
